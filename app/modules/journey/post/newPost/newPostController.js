...
.controller('NewPostController', function ($scope, $rootScope, $http, CurrentUser, $upload, apiUrl, Journey) {
  ...
  this.journey = _.filter(this.currentJourneys, function(j){ return j.id == $scope.params.journey_id})[0];
    ...
    if(this.step == 2) {
      ...
      Journey.post({
        ...
        function(user){
          ...
          _.each(CurrentUser.user.journeys, function(j) {
