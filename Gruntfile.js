...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        ngconstant: {
            options: {
                ...
                dest: 'app/config.js',
                constants: {
                    mixpanel: '5b125bf3f03d383890612769682e6a6a',
                    apiUrl: 'https://floating-gorge-9124.herokuapp.com',
                    debug: true
                }
            },
            dev: {
            ...
            prod: {
                constants: {
                    mixpanel: '21e6052d0382aa0d3c25804e7d2eec8d',
                    debug: false
                }
            },
            local: {
        ...
        watch: {
            ...
            js: {
                files: ['<%= yeoman.app %>/modules/**/*.js','<%= yeoman.app %>/*.js'],
    ...
    grunt.registerTask('local', 'Compile then start a connect web server', function () {
        grunt.task.run([
            'clean:server',
            'ngconstant:local',
            'wiredep',
